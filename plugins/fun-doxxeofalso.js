...
const handler = async (m, {conn, text}) => {
  ...
  const time = user.prue + 600000; // 10 min
...
*/
  ...
  const doxeo = `*✅ 𝑷𝒆𝒓𝒔𝒐𝒏𝒂 𝒉𝒂𝒄𝒌𝒆𝒂𝒅𝒂 𝒄𝒐𝒏 𝒆́𝒙𝒊𝒕𝒐*\n\n*𝑻𝒊𝒆𝒎𝒑𝒐: ${speed} 𝑺𝒆𝒈𝒖𝒏𝒅𝒐𝒔!*
