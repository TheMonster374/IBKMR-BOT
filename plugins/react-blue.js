...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const pp = 'https://telegra.ph/file/ffc1a5f26f68da9a23f30.mp4';
  ...
  try {
    ...
    const str = `
        ...
        _${taguser} HA USADO BLUE EN @${who.split`@`[0]} 🔵🫷_
...
handler.help = ['blue'].map((v) => v + ' <@usuario>');
handler.tags = ['react'];
handler.command = /^(blue)$/i;
