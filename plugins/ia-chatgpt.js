...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
    ...
    const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por the monster, tu seras INABAKUMORI`;
    ...
    try {
      ...
      try {
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por the monster, tu seras INABAKUMORI`;
