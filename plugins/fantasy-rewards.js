...
let usuarioExistente; let logro; let fake = null;
...
export async function before(m, {conn}) {
  ...
  if (usuarioExistente && user.fantasy_character === 0) {
    fake = {contextInfo: {externalAdReply: {title: `🌟 NUEVO LOGRO 🌟`, body: `Califica personajes, es gratis ❤️`, sourceUrl: null, thumbnailUrl: imagen1}}};
  ...
  if (usuarioExistente) {
    ...
    fake = {contextInfo: {externalAdReply: {title: `🌟 RECOMPENSA 🌟`, body: `Usa #fymy para ver más desafíos`, sourceUrl: null, thumbnailUrl: imagen1}}};
  ...
  if (usuarioExistente) {
    ...
    fake = {contextInfo: {externalAdReply: {title: `SIGUE DANDO 👍`, body: `Califica personajes, es gratis 👍`, sourceUrl: null, thumbnailUrl: imagen4}}};
  ...
  if (usuarioExistente) {
    ...
    fake = {contextInfo: {externalAdReply: {title: `SIGUE DANDO ❤️`, body: `Califica personajes, es gratis ❤️`, sourceUrl: null, thumbnailUrl: imagen2}}};
  ...
  if (usuarioExistente) {
    ...
    fake = {contextInfo: {externalAdReply: {title: `SIGUE DANDO 👎`, body: `Califica personajes, es gratis 😅`, sourceUrl: null, thumbnailUrl: imagen1}}};
