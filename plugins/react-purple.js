...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const pp = 'https://telegra.ph/file/a791e8a164c8a301b6238.mp4';
  const pp2 = 'https://telegra.ph/file/be0458f52cf50d2b0ee31.mp4';
  ...
  try {
    ...
    const str = `
        ...
        _${taguser} HA USADO PURPLE EN ${text} CAGASTE 🔵🫷💀🫴🔴_
