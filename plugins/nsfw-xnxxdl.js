...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!db.data.chats[m.chat].nsfw && m.isGroup) throw '*los comandos  +18 estan desactivados en este grupo, si es admin y desea activarlos use el comando #enable nsfw*';
