...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*_Ingrese un enlace de X (twitter)_*\n\n *ejemplo:* ${usedPrefix + command}* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw`;
  if (enviando) return;
  enviando = true;
  try {
