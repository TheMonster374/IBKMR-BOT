...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const pp = 'https://telegra.ph/file/78a4b771365282e763d74.mp4';
  const pp2 = 'https://telegra.ph/file/4ac56befb5c4952074d2b.mp4';
  const pp3 = 'https://telegra.ph/file/1fc99615e40f26cdbf78c.mp4';
  const pp4 = 'https://telegra.ph/file/15b4911558283cd155639.mp4';
  const pp5 = 'https://telegra.ph/file/b8e5464f6fea11aba2916.mp4';
  const pp6 = 'https://telegra.ph/file/c5f1e58c9d6580915970c.mp4';
  ...
  try {
    ...
    const str = `
        ...
        _${taguser} HA GOLPEADO A ${text} 🫣😱_
...
handler.help = ['punch'].map((v) => v + ' <@usuario>');
handler.tags = ['react'];
