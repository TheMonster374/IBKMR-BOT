...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const pp = 'https://telegra.ph/file/b85a02fb77c203fc1fa38.mp4';
  const pp2 = 'https://telegra.ph/file/47446bb252c1d308de494.mp4';
...
handler.help = ['blackflash'].map((v) => v + ' <@usuario>');
handler.tags = ['react'];
handler.command = /^(blackflash)$/i;
