...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const pp = 'https://telegra.ph/file/e427bf7e1e28350ff4c62.mp4';
  const pp2 = 'https://telegra.ph/file/3cceebaf0fd97cbdcc074.mp4';
  const pp3 = 'https://telegra.ph/file/efa64471182ca6d775c16.mp4';
  const pp4 = 'https://telegra.ph/file/0c442b3c3d9e14ca2d357.mp4';
  const pp5 = 'https://telegra.ph/file/19dffe718c967dfe357f6.mp4';
  const pp6 = 'https://telegra.ph/file/729e99a050bfc0cebc737.mp4';
  ...
  try {
    ...
    🤤¡${taguser} SE HA COGIDO A @${who.split`@`[0]}!🤤\n
😈¡
@${who.split`@`[0]}! *TE HAN VIOLADO*😈\n
*¡QUE PUTA ERES!* 🥵
