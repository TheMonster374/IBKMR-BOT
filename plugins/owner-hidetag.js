...
**/
    ...
    const htextos = `${text ? text : '*Hola soy INABAKUMORI*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://atom.bio/tm'}}}}}, {});
    }
  }
};
handler.help = ['all <mesaje>'];
handler.tags = ['owner'];
handler.command = /^(everyone|all|tag)$/i;
handler.group = true;
handler.rownee = true;
