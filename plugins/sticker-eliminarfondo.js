...
const handler = async (m, {conn, text}) => {
  try {
    ...
    const sremovebg = global.API(`https://api.lolhuman.xyz/api/removebg?apikey=85faf717d0545d14074659ad&img=${url}`);
...
handler.command = /^sremovebg|removebg|borrarfondo|eliminarfondo$/i;
