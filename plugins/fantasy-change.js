...
let id_message; let pp; let dato; let fake; let user = null;
const validClasses = ['Común', 'Poco Común', 'Raro', 'Épico', 'Legendario', 'Sagrado', 'Supremo', 'Transcendental'];

const handler = async (m, {command, usedPrefix, conn, text}) => {
  user = global.db.data.users[m.sender];

  const accountsgb = 'https://whatsapp.com/channel/0029VabyyaKGehEIyunTGo0t';

  const gataImg = './Menu.png';

  const gataMenu = 'https://i.pinimg.com/originals/b4/a1/91/b4a191e1d7f4d288f3b1204b159a9ff8.gif';
...
handler.tags = ['rpg'];
handler.help = ['fychange <fantasia>'];
