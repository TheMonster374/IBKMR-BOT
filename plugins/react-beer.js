...
const handler = async (m, {conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems}) => {
  ...
  const pp = 'https://telegra.ph/file/ca56fd6ab0139e296073d.mp4';
  const pp2 = 'https://telegra.ph/file/47dc86b46947ef64332de.mp4';
  const pp3 = 'https://telegra.ph/file/d4103b64b26cd137d4bff.mp4';
  const pp4 = 'https://telegra.ph/file/d3e29840419301d6e4a8f.mp4';
  const pp5 = 'https://telegra.ph/file/4c09e0cd5b471bc6e945a.mp4';
  ...
  try {
    ...
    const str = `
        ...
        _${taguser} ESTA TOMANDO CERVEZA 🍻🥴_
